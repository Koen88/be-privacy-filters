...
3. Under “Custom”, add:  
   ```
   https://raw.githubusercontent.com/Koen88/be-privacy-filters/refs/heads/main/ubo/ubo-be-tracking.txt
   ```
5. Apply changes
...
Add this URL:  
```
https://raw.githubusercontent.com/Koen88/be-privacy-filters/refs/heads/main/ubo/ubo-be-cosmetic.txt
```
Then apply changes.
